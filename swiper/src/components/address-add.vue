        ...
        <div class="flexitemv mainbox">
            ...
            <form class="flexv padlft">
                ...
                <label class="between input" style="align-items:center">
                    ...
                    <v-distpicker :placeholders="placeholders" @selected="selectArea"></v-distpicker>
                </label>
    ...
    export default{
        ...
        methods: {
            save(){
                ...
                /*this.$http.post('address', address).then(ret => {
                    this.$store.commit('address_append', ret.data);
                    this.$router.go(-1);
                });*/
                this.$store.commit('address_append', address);
                this.$router.go(-1);
                if (sessionStorage.getItem("id") == null) {
                    address.id = 1
                } else {
                    address.id = parseInt(sessionStorage.getItem("id")) + 1;
                }
            },
